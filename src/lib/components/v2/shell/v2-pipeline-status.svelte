...
<section id="pipeline" class="v2-section v2-pipeline-section" aria-labelledby="pipeline-title">
  <header class="v2-section__header"><div><p>PIPELINE TELEMETRY</p><h2 id="pipeline-title">Pipeline status</h2></div><span>{status.schedule.human.toUpperCase()}</span></header>
  <div class="v2-pipeline" data-state={state} aria-label="Pipeline status">
